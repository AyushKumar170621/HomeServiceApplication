...
const { newBooking, getSingleBooking, myBookings, getAllBookings, updateBooking, setOTP, deleteBooking, updateBookingProvider, getAllProvidersBookings, logProBookings }  = require("../controllers/bookingController");
...
router.route("/provider/mybookings").get(isAuthenticatedUser,authorizedRoles("provider"),logProBookings);
...
router.route("/provider/update/booking/:id").get(isAuthenticatedUser,authorizedRoles("provider"),setOTP).put(isAuthenticatedUser,authorizedRoles("provider"),updateBookingProvider);
